 ...
 const keywords = ['fuck','bitch','suck','myr',
    "speaker","partner","resource",'event','organize','regist','mail',
    'contact','navigate','thank','about','yourself','hi','hello','hey','sup','neo','dawn','help','sorry','ok','how','doing'];
...
'about neo dawn','about neo dawn','','','','',"about neo dawn",'about neo dawn',
