 ...
 const keywords = ['fuck','bitch','suck','myre',
    ...
    'contact','thank','about','yourself','hi','hello','hey','sup','neodawn','help','sorry','ok'];
...
'registration date will be anounced soon','our mail id is dvfhdgfhg','lets go to the contacts',
'about neo dawn','about neo dawn','','','','','Happy to help :)',"about neo dawn",
'I am here to help you. Plaese be specific about you request','its alright',':)'];
...
function handleMessage(userMessage) {
    ...
    userBubble.style.color='red';
    userBubble.style.background='white';
    ...
    userBubble.style.maxWidth='190px';
...
text+="Oops, Can\'t help you.Please check the spellings and try again or go to \'help\' in the navbar";
   ...
   botres.style.color='blue';
   botres.style.background='white';
